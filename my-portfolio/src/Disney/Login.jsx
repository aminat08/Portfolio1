    ...
    <div style={{fontFamily:'cursive'}}>
        <div className='bg-white flex flex-col  ml-20 mt-5  px-10 py-10 w-[400px] h-[500px] shadow-xl'>
            ...
            <form className=' space-y-4 ' onSubmit={handleLogin}>
                ...
                <input type="password" value={password} placeholder='Please enter your password' className='bg-pink-400 px-5 py-3  w-full font-medium  rounded-xl text-white placeholder:text-amber-50 focus:outline-0 shadow-md' onChange={(e)=>setPassword(e.target.value)}  />
